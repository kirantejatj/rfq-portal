...
import { 
  ...
  Filter, CheckCircle2, AlertCircle, Award, FileText
} from 'lucide-react';
            ...
            <div className="flex flex-wrap justify-between items-center gap-3">
              <div className="flex items-center space-x-2 flex-1 max-w-md">
                <div className="relative w-full">
                  ...
                  <input
                    type="text"
                    placeholder="Search RFQs by Title or Reference No..."
                    value={rfqSearch}
              ...
              <div className="flex items-center space-x-2 text-xs">
                ...
                >
                  <option value="ALL">All Statuses ({tenders.length})</option>
                    ...
                    filteredTenders.map(t => (
                      <tr key={t.tender_id} className="hover:bg-slate-50/80 transition">
                        ...
                        <td className="py-3 px-3 max-w-xs">
                          ...
                          <span className="text-[10px] text-slate-400 block">{t.completion_period || 'Standard timeline'}</span>
                        </td>
                        ...
                        <td className="py-3 px-3 text-center">
                          <div className="flex items-center justify-center space-x-2">
                            <Link
                              ...
                              className="px-2.5 py-1 bg-amber-50 hover:bg-amber-100 text-amber-900 font-bold rounded border border-amber-200 text-xs flex items-center transition"
                            ...
                            <select
                              ...
                              className="px-2 py-1 border rounded text-[11px] font-semibold bg-white text-slate-700"
                            >
                              <option value="PUBLISHED">PUBLISHED</option>
                              <option value="DRAFT">DRAFT</option>
                              <option value="CLOSED">CLOSED</option>
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="overflow-x-auto border border-slate-100 rounded-xl">
              <table className="w-full text-left text-xs border-collapse">
                <thead>
                  <tr className="bg-slate-50 text-slate-600 font-bold border-b border-slate-200 uppercase tracking-wider">
                    <th className="py-3 px-3">Quotation ID / Ref</th>
                    ...
                    <th className="py-3 px-3">Status</th>
                    <th className="py-3 px-3 text-center">Evaluation Action</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100">
                      ...
                      <tr key={q.application_id} className="hover:bg-slate-50/80 transition">
                        ...
                        <td className="py-3 px-3 text-center">
                          <Link
                            ...
                            className="px-3 py-1.5 bg-gov-600 hover:bg-gov-700 text-white font-bold rounded-lg text-xs inline-flex items-center shadow-sm transition"
                          >
