    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-gov-900 via-gov-800 to-gov-700 rounded-2xl p-8 text-white shadow-xl mb-8 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl space-y-4">
          <div className="inline-flex items-center space-x-2 bg-amber-400/20 text-amber-300 border border-amber-400/30 px-3 py-1 rounded-full text-xs font-semibold">
            <span>✨ AGIC Infrastructure Procurement System</span>
          </div>
      ...
      {loading ? (
        <div className="text-center py-20">
          ...
          <p className="text-slate-500 text-sm">Loading RFQs from database...</p>
        </div>
      ) : filtered.length === 0 ? (
        <div className="bg-white rounded-xl border border-slate-200 p-12 text-center shadow-sm">
          <FileCheck className="w-12 h-12 text-slate-300 mx-auto mb-3" />
          <h3 className="text-base font-bold text-slate-700">No RFQs Found</h3>
          <p className="text-slate-500 text-xs mt-1">There are currently no RFQs matching your filter criteria.</p>
        </div>
      ) : (
            ...
            >
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 bg-slate-50 p-3 rounded-lg border border-slate-100 text-xs mb-3">
                  ...
                  <div>
                    <span className="text-slate-400 block text-[10px] uppercase font-semibold">Quotation Validity</span>
